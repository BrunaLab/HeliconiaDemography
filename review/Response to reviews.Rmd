...
One way we approached this is by excluding areas of the heatmap that are far from data, equivalent to not drawing regression lines beyond the range of data.
We implemented this with the `exclude.too.far()` function in the `mgcv` package.
Displaying raw data or residuals on the heatmaps was too messy and not informative in a 2d plot.
Instead, we have explored "slices" of these heatmaps in a supplement <!--# TODO, make that supplement! -->.
...
<!--# figure should be back-transformed -->
...
<!--# I think this will become more clear if I switch to plotting these as back-transformed. -->
