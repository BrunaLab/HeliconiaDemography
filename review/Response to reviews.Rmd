...
<!--# need to check the line to figure out the source of confusion, but we did test this with 84%CI overlap -->

##  {#R2-11}

> Line 370: There are no confidence intervals in Fig 2, so we don't know if the difference is significant.

<!--# this is not a plot that can have CIs.  The line doesn't imply statistical significance either.  Not sure how to respond -->
