...
<!--# wouldn't this reduce growth?  Not what we saw in our results, so not sure how this is relevant? -->
...
<!--# but we just said drought also removes tissue in the previous sentence.  Am I missing something? -->
...
While we believe we did discuss *Heliconia*-specific mechanisms for delayed responses of flowering (L 434--438, now <!--# new line -->) and delayed effects on growth (L 445--450, now <!--# new line -->), the reviewer is correct that we had not previously discussed mechanisms behind mortality.
