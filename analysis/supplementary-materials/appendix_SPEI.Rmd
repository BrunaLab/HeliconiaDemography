...
-   Move imputation code to this notebook. This requires finishing up the bdffp precip R package.
...
```{r}
# Read in data 
bdffp_daily <- read_csv("https://raw.githubusercontent.com/BrunaLab/Heliconia-Drought/master/data_cleaned/daily_precip.csv?token=AGB2K35OCIPUILNGOD6VXV3AH7XOU")
