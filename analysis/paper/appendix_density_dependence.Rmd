...
Plant size had a significant, nearly quadratic (on a logit scale), effect on survival in continuous forest ($\chi^2$ = 112.2, edf = 2.1, P \< 0.001), but a linear (on a logit scale) effect in 1 ha fragments ($\chi^2$ = 15.63, edf = 1, P \< 0.001) (Figure \@ref(fig:surv-plot)). However, there were no significant effects of habitat ($\chi^2$ = 0.002, df = 1, P = 0.964) or conspecific density ($\chi^2$ = 5.326, edf = 2, P = 0.0699) on survival.
