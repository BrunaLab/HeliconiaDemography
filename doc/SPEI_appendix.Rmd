...
spei_table <-
  ...
  mutate(TRMM = ifelse(TRMM == "NA (NA)", "–", TRMM)) %>% 
  ungroup()
...
table <- 
  ...
  bg(~ spei_bdffp < -2, ~BDFFP, bg = "#e31a1c") %>% 
  ...
  bg(~ between(spei_bdffp, -2, -1.5), ~ BDFFP, bg = "#fd8d3c") %>% 
  ...
  bg(~ between(spei_bdffp, -1.5, -1), ~ BDFFP, bg = "#fecc5c") %>% 
  ...
  bg(~ between(spei_bdffp, -1, 0), ~ BDFFP, bg = "#ffffb2")
```
