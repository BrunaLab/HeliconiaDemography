...
It is important to emphasize, however, that the overall effects of SPEI on survival and growth are more severe in fragments than continuous forest (Figures \@ref(fig:surv-spei), \@ref(fig:growth-spei)).
...
We suggest it is these climate extremes, rather than trends in average temperature, precipitation, or SPEI [@lauranceApparentEnvironmentalSynergism2014], that that are the causal mechanism underlying reduced plant growth and survival in forest fragments.
