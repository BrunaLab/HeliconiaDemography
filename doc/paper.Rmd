...
Fragmentation is associated with myriad ecological changes, including the local and regional extinction of plant species [@laurance2006a; @dasilva2000].
...
While many *Heliconia* species grow in large patches in trefall gaps and other disturbed areas, others, such as *H. acuminata,* are found at lower densities in the darker and cooler forest understory [@rundel2020].
These species produce fewer infloresences and are pollinated by traplining rather than territorial hummingbirds [@stouffer1996d; @bruna2004].
...
Here we support the emerging generalization that the effects of climate drivers on demographic vital rates can be delayed [@tenhumbergTimelaggedEffectsWeather2018; @tellerLinkingDemographyDrivers2016; @eversLaggedDormantSeason2021].
...
Similar delayed changes in the local environment could also influence the foraging behavior of *H. acuminata*'s pollinators [@brunaHeliconiaAcuminataReproductive2004; @stouffer1996d] and seed dispersers [@uriarteDisentanglingDriversReduced2011].
