...
Running title: `r rmarkdown::metadata$shorttile`
...
Survival probability did not differ significantly between continuous forest and 1 ha fragments (intercept estimate and 84% CI were 0.972 [0.967, 0.976] and 0.966 [0.961, 0.971] for continuous forest and 1 ha fragments, respectively) <!--# not sure if this is where this goes -->.
...
However, the main effect of habitat on log(size) was not significant (intercept and 84% CIs were 4.41 [4.38, 4.44] and 4.36 [4.22, 4.5] for continuous forest and 1 ha fragments, respectively) <!--# not sure if this is where this goes -->.
...
However, the main effect of habitat on flowering probability was not significant (intercept and 84% CIs were 0.0059 [0.0042, 0.0082] and 0.0033 [0.0016, 0.007] for continuous forest and 1 ha fragments, respectively) <!--# not sure if this is where this goes -->.
...
The responses in 1-ha fragments were also more muted (1-ha edf = 8.3, continuous forest edf = 10.6), as indicated by the shape of the crossbasis function (Figure \@ref(fig:flwr-spei)a).
...
In both forest and fragments, flowering in the previous year was significantly positively related to growth (CF: $p = 0.048$; 1-ha: $p = 0.030$) and flowering (CF: $p < 0.001$; 1-ha: $p = 0.004$) meaning that plants which had flowered in the previous year were more likely to be larger and flower again, on average.
