...
While the effect was generally similar across size classes and habitat types, the impact of plant size on size in the following year was greatest for mid-sized plants in continuous forest (Figure \@ref(fig:size-plot)a).
