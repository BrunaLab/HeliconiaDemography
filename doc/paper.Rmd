...
<!--# I'd like to cite nothdurft et al.  Possibly as an example of a three-way interaction.  Theirs is temperature x precip x lag, but could be used for SPEI x size x lag *if* we had plant size on the same time scale as SPEI.  Maybe a discussion sentence. -->
