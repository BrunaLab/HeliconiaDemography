...
Preliminary modeling with data subsets showed that excluding individual-level random effects reduced model R^2^, but did not affect the shape or statistical significance of the smooths.
