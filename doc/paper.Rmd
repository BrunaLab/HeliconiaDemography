...
```{r eda_hires, fig.height=7, fig.width=7, dev='tiff', include=FALSE}
tar_read(eda_plot) & theme(text = element_text(size = 10))
```
...
```{r surv-curve_hires, fig.height=3.5, fig.width=7, dev="tiff", include=FALSE}
tar_read(surv_curve) + theme(text = element_text(size = 10))
```
...
```{r size-plot_hires, fig.width=7, fig.height=7, dev='tiff', include=FALSE}
tar_read(size_plot) & theme(text = element_text(size = 10))
```
...
```{r surv-spei_hires, fig.height=7.5, fig.width=7, dev='tiff', include=FALSE}
tar_read(s_spei_plot) & theme(text = element_text(size = 10))
```
...
```{r growth-spei_hires, fig.height=7.5, fig.width=7, dev='tiff', include=FALSE}
tar_read(g_spei_plot) & theme(text = element_text(size = 10))
```
...
```{r flwr-spei_hires, fig.height=7.5, fig.width=7, dev='tiff', include=FALSE}
tar_read(f_spei_plot) & theme(text = element_text(size = 10))
```
