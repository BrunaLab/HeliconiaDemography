...
We found no evidence for a cost of reproduction.
In both forest and fragments, flowering in the previous year was significantly positively related to growth (CF: $p = 0.048$, 1-ha: $p = 0.031$) and flowering ($p < 0.001$ for both CF and 1-ha) meaning that plants which had flowered in the previous year were more likely to be larger and flower again, on average.
