...
This shows that in average conditions (SPEI = 0), there is little difference in survival probability between continuous forest and forest fragments (Figure \@ref(fig:surv-spei)c) <!--# is this where I should mention the overlap in 84%CI around the intercepts? -->.
