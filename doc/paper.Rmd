...
Survival probability did not differ significantly between continuous forest and 1 ha fragments (estimate and 84% CI were `r pull_ci(tar_read(s_cf))` , and `r pull_ci(tar_read(s_1ha))` for continuous forest and 1 ha fragments, respectively).
