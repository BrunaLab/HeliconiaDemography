...
It is only when evaluating over longer time windows that it becomes apparent mortality is elevated in fragments relative fo continuous forest (**Fig 2**), and that the observed interannual variation is largely driven by dynamic patterns of recruitment [@brunaEffectsForestFragmentation2002] coupled with low mortality for plants beyond the smallest size classes [@bruna2003b].
